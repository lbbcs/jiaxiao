<template>
  <div class="container">
    ...
    <div style="width: 350px; padding: 30px; background-color: rgba(255,255,255,0.8); border-radius: 5px;">
      <div style="text-align: center; font-size: 24px; margin-bottom: 30px; color: #333; font-weight: bold">欢迎注册</div>
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item>
          <el-button size="medium" style="width: 100%; background-color: saddlebrown; border-color: saddlebrown; color: white" @click="register">注 册</el-button>
        </el-form-item>
