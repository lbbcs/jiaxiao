<template>
  <div>
    ...
    <el-dialog title="消息通知" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        <el-form-item label="消息内容" prop="content">
          <el-input v-model="form.content" placeholder="消息内容"></el-input>
        </el-form-item>
        <el-form-item label="用户ID" prop="userId">
          <el-input v-model="form.userId" placeholder="用户ID"></el-input>
        </el-form-item>
        <el-form-item label="是否已读" prop="isread">
          <el-input v-model="form.isread" placeholder="是否已读"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    updateRead() {
      this.$request.put('/message/updateRead').then(res => {
        this.load(1)
        // 触发父级的数据更新
